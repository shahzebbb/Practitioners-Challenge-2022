...
test <- sp.model.fit@fit[["sigma"]]

write.csv(test, 'spgarchsigma.csv')
...
```{r}
sp_list_ES_actual <- ES_actual(sp_test_data_residuals,0.05)
dow_list_ES_actual <- ES_actual(dow_test_data_residuals,0.05)
nas_list_ES_actual <- ES_actual(nas_test_data_residuals,0.05)
```
