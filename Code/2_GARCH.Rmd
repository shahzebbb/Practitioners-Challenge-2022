...
dow.model.fit <- ugarchfit(dow.model, dow_residuals, solver = 'solnp', out.sample = 1283)
...
```{r}
sp.model.forecast.seven <- ugarchforecast(sp.model.fit, sp_residuals, n.ahead=7,n.roll=1031)@forecast[["sigmaFor"]]
```
