...
plot(sp$Date[-length(sp$Date)],sp_logret,type='l')
plot(dow$Date[-length(dow$Date)],dow_logret, type='l')
plot(nas$Date[-length(nas$Date)],nas_logret, type='l')
```
...
Does not work (Add comment on using non-stationary data and no changepoints)
