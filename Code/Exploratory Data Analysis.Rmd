...
```
 ...
 The log-returns have much heavier tails than the normal distribution, which suggests that it might follow a Student's t-distribution. Let's explore this fact':
 
```{r}
library(limma)
qqt(sp_logret,df=Inf)
???
```
